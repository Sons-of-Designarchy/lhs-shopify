if (!window.appointlyConfig) {
  window.appointlyConfig = {
    ...
    clientUniqueId: "VQMZ4WTTIWIH81M8W9J8EVNU",
    booking: {
      bookingHtml: `<html>
<head>
  <meta charset='utf-8'>
...
`,
    ...
    depositPaymentSettings: {"createdAtTimeStamp":1661809654285,"shouldDelete":false,"isEnabled":false,"options":[],"uniqueId":"UIUZDR71TL89UN74RI5Y1PEF","depositPaymentScreenInfoSettings":{"headingText":"Payment Options (Pay Deposit amount now, and remaining after the appointment): "},"checkoutInfoText":{"titleText":"Deposit for Service","remainingAmountText":"Remaining Balance before Tax and Shipping"}},
    productId: '',
    bookingId: '',
    auth: '',
